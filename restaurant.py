...
conn.execute('''CREATE TABLE IF NOT EXISTS RESTAURANT_BILL
(ORDER_NO INT PRIMARY KEY NOT NULL,
FRIES_MEAL INT NOT NULL,
LUNCH_MEAL INT NOT NULL,
BURGER_MEAL INT NOT NULL,
PIZZA_MEAL INT NOT NULL,
CHEESEBURGER INT NOT NULL,
DRINKS INT NOT NULL,
COST INT NOT NULL,
...
def Ref():
    ...
    costmeal = int(costoffries +  costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks)
    ...
    query = f'''INSERT INTO RESTAURANT_BILL
    VALUES({x}, {costoffries}, {costoflargefries}, {costofburger}, {costoffilet}, {costofcheeseburger}, {costofdrinks}, {costmeal},
    {Ser_Charge}, {PayTax}, {costmeal}, {Totalcost})
    '''
    print(query)
    conn.execute(query)
    conn.commit()
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By 168 & 174",bd=2,relief=SUNKEN)
